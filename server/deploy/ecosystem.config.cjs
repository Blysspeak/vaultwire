...
// Пути абсолютные и указывают на чекаут на сервере: pm2 стартует из своей рабочей
// директории, относительные пути тут ломаются молча.
const ROOT = '/root/project/vaultwire/server';
