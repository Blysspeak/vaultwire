...
export interface ConnectionSettings {
  ...
  autoSync: boolean;
  /** Хранить пароль шифрования здесь же; выключено — окно на каждом запуске. */
  rememberPassword: boolean;
  /**
   * Пароль шифрования в открытом виде; null — не сохранён. Шифровать его нечем:
   * ключ пришлось бы держать в этом же файле, и защита была бы ложной.
   * В экспорт диагностики не попадает никогда.
   */
