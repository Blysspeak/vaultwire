...
export const RU_APP = {
  ...
  'unlock.password.desc': 'Общий на команду, передаётся вне плагина. На сервер не уходит никогда.',
  'unlock.remember.name': 'Запомнить пароль на этом устройстве',
  'unlock.remember.desc':
    'Пароль будет сохранён в открытом виде в файле настроек плагина внутри хранилища.',
  'unlock.stale': 'Сохранённый пароль не подошёл и стёрт: введите пароль заново.',
